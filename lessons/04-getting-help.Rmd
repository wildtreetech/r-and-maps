...
XXX bottom of https://github.com/rhodyrstats/intro_r_workshop/blob/master/lessons/01_basics.Rmd

> ## The ggplot2 CRAN page
>
> Take a look at the [`ggplot2` CRAN page](https://cran.r-project.org/web/packages/ggplot2/index.html). Can you
> find the manual and vignettes?
